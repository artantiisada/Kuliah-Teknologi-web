...
<div class="container">
 ...
 <table>
  ...
  <tr>
   <td width="100">Nim</td>
   <td>: <span class="result-nim"></span></td>
  </tr>
  <tr>
   <td width="100">Nama</td>
 ...
 <table class="table" width="100%">
  ...
  <td align="center">
  <a href="#" class="control" data-set="lihat" data-nim="<?php echo $nim; ?>" data-nama="<?php echo $nama; ?>" data-alamat="<?php echo $alamat; ?>">lihat</a> | 
  <a href="#" class="control" data-set="edit" data-nim="<?php echo $nim; ?>" data-nama="<?php echo $nama; ?>" data-alamat="<?php echo $alamat; ?>" data-url="aksi.php?set=edit&id=<?php echo $id; ?>">edit</a> | 
...
$(function(){
 $('.control').on('click', function(){
  ...
  if($set == 'tambah'){
   ...
   $('.content-view .result-nim').html($nim);
